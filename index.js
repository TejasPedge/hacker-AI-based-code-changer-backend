...
app.post('/qualitycheck', async (req, res) => {
  ...
  try {
    ...
    const prompt = `Check the quality of the following code for example check if the code follow good coding practices and it has proper spaces and suggest thhat how it should be :\n\n${code}`;
